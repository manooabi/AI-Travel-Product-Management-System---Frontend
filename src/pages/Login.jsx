          ...
          <div className="relative z-10 flex w-full flex-col justify-between p-10 xl:p-14">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-6 max-w-lg text-sm leading-7 text-slate-400 xl:text-base">
                Create, manage and discover travel products from one
                professional workspace powered by AI.
              </p>
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Access your travel product management dashboard.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    autoComplete="email"
                    className="block w-full rounded-xl border border-slate-200 bg-white px-3.5 py-3 pl-10 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative mt-2">
                  ...
                  <input
                    ...
                    className="block w-full rounded-xl border border-slate-200 bg-white px-3.5 py-3 pl-10 pr-11 text-sm text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50"
                    required
                  />
              ...
              <button
                type="submit"
                disabled={loading}
                className="flex w-full items-center justify-center gap-2 rounded-xl bg-indigo-600 px-4 py-3 text-sm font-semibold text-white shadow-sm shadow-indigo-200 transition duration-200 hover:bg-indigo-700 hover:shadow-md disabled:cursor-not-allowed disabled:opacity-60 disabled:hover:bg-indigo-600"
              >
                {loading ? (
                  <>
                    <svg
            ...
            <p className="mt-8 text-center text-[11px] leading-5 text-slate-400">
              Secure access to your TravelAI workspace.
            </p>
          </div>
        </div>
      </div>
